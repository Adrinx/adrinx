...
export default function MediaLarge({ slides }: MediaSliderProps) {
        ...
        {slides.map((slide, index) => {
          ...
          return (
            <div
              ...
              className="flex-none w-[400px] h-[200px] rounded-lg overflow-hidden bg-black shadow cursor-zoom-in"
            >
              {isVideo ? (
                <video
                  src={slide}
